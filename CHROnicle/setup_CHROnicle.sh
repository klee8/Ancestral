...
sort -k3,3 -k4,4n Eama708.rdef > Eama708.srdef
mv Eama708.srdef Eama708.def
rm Eama708.rdef
perl ./scripts/make_ch.pl Eama708.def Eama708
...
# sort new def file by chromosome and position
sort -k3,3 -k4,4n Eely728.rdef > Eely728.srdef
mv Eely728.srdef Eely728.def
rm Eely728.rdef
perl ./scripts/make_ch.pl Eely728.def Eely728
...
# sort new def file by chromosome and position
sort -k3,3 -k4,4n EfesFl1.rdef > EfesFl1.srdef
mv EfesFl1.srdef EfesFl1.def
rm EfesFl1.rdef
perl ./scripts/make_ch.pl EfesFl1.def EfesFl1
